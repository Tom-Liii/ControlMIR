    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataset):
            with accelerator.accumulate(controlnet):
                ...
                control_image_list = [[0, 0, 0, 0, 0, 0, batch_img, 0] for batch_img in batch["pixel_values"]]
                ...
                # refer to the original controlnet paper
                ...
                if args.controlnet_model_name_or_path is not None: # using controlnetplus, hence change controlnet_cond to controlnet_cond_list
                    ...
                    controlnet_cond_list=control_image_list, # ! very possible bugs, TODO: conditioning image need many preprocessings
                    return_dict=False,
                )
                else:
                    union_control_type=torch.Tensor([0, 0, 0, 0, 0, 0, 1, 0]) # control type for super resolution
                ...
                model_pred = unet(
                    noisy_latents,
                    timesteps,
                    encoder_hidden_states=batch["prompt_ids"].to(accelerator.device),
